...
$app->get('/demandante', function (Request $request, Response $response){
...
$app->get('/demandante/{usuario}', function(Request $request, Response $response){
...
$app->post('/demandante/new', function(Request $request, Response $response){
